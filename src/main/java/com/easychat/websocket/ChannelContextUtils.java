...
public class ChannelContextUtils {
	...
	/**
	 * 处理用户上线后的各种初始化操作，包括设置用户与 Channel 的关联、更新用户上下文、处理离线消息、更新用户信息和发送初始化消息。
	 * @param userId
	 * @param channel
	 */
	public void addContext(String userId, Channel channel) {
		...
		wsInitData.setSessionUserList(chatSessionlList);
		...
		wsInitData.setMessagesList(messageList);
